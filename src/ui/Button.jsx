...
function Button({ children, type, to }) {
  ...
  const styles = {
    link: `bg-crust text-maroon ${!isMounted ? `translate-y-4 opacity-0` : `translate-y-0 opacity-100`} cursor-pointer rounded-3xl px-4 py-5 text-sm transition-all  hover:bg-cheese font-semibold duration-1000 ease-in-out`,
